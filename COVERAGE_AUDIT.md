# multipeerconnectivity-rs coverage audit (vs MacOSX26.2.sdk)
...
| `-initWithPeer:` | method | `MCSession.h` | `Session::new` (covers the same nil-identity session construction path via the designated initializer) |
| `-initWithPeer:securityIdentity:encryptionPreference:` | method | `MCSession.h` | `unsafe Session::with_security_identity`, `Session::with_security_identity_items` |
...
| `delegate` | property | `MCSession.h` | `Session::set_delegate`, `Session::set_callbacks`, `Session::clear_delegate` (write-only delegate management) |
...
| `delegate` | property | `MCNearbyServiceAdvertiser.h` | `NearbyServiceAdvertiser::set_delegate`, `NearbyServiceAdvertiser::set_callbacks`, `NearbyServiceAdvertiser::clear_delegate` (write-only delegate management) |
...
| `delegate` | property | `MCNearbyServiceBrowser.h` | `NearbyServiceBrowser::set_delegate`, `NearbyServiceBrowser::set_callbacks`, `NearbyServiceBrowser::clear_delegate` (write-only delegate management) |
...
| `delegate` | property | `MCAdvertiserAssistant.h` | `AdvertiserAssistant::set_callbacks`, `AdvertiserAssistant::clear_delegate` (write-only delegate management) |
...
| `delegate` | property | `MCBrowserViewController.h` | `BrowserViewController::set_callbacks`, `BrowserViewController::clear_delegate` (write-only delegate management) |
